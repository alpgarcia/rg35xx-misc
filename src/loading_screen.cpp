...
void drawProgressBar(TTF_Font* font, int fps, int current_process, int completed, int total, 
                     std::string message, SDL_Surface* buffer, Uint32 bg_color) {
...
int main(int argc, char *argv[])
{
    ...
    while (running) {
        ...
        drawProgressBar(font, fps, current_process, completed, nscripts, status_message, buffer, BG_COLOR);
